...
public class SingletonSerialize implements Serializable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("C:\\Users\\anupb\\IdeaProjects\\DesignPatterns\\src\\com\\myjavablog\\creational\\singleton\\tmp\\s2.ser"));
        oos.writeObject(sr2);

        ObjectInputStream ois = new ObjectInputStream(new FileInputStream("CC:\\Users\\anupb\\IdeaProjects\\DesignPatterns\\src\\com\\myjavablog\\creational\\singleton\\tmp\\s2.ser"));
